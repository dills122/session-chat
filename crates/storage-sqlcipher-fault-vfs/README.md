...
behavior, closed role/ordinal validation, optional-service forwarding, and
fail-closed null or missing callback slots. The crate is a root-workspace member
so the common Rust matrix exercises it on Linux, macOS, and Windows.
