use key_protector_passphrase::{
    MAX_PASSPHRASE_BYTES, PortableKeyError, PortablePassphrase, PortablePassphraseKeyWrapper,
    WRAPPED_SESSION_KEY_V1_BYTES, WrappedSessionKeyV1,
};
use session_storage::{
    BackupExposure, DeviceBinding, KeyStorageProtection, ProtectionLevel, ProtectorCapabilities,
