...
| `sessionctl` | 292/373 (78.28%) | 1676/1839 (91.14%) | 90% |
...
| **Workspace** | **8034/8850 (90.78%)** | **10463/11251 (93.00%)** | **92.23% ratchet** |

The workspace also moved from 86.88% to 88.66% region coverage and from
83.47% to 89.57% function coverage. CI retains its existing stable floors at
