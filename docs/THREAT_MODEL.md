...
PATH-selected Git, and compiler output are not authentication. ADR 0027 requires
...
SQLite and tamper-copy writes through links. ADR 0027 places core and spike test
