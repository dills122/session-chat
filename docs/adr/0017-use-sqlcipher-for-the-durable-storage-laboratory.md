...
the retained L2-8 matrix promotes only complete clean-runner aggregates after
exact provenance/artifact binding and multi-surface canary scans. Portable
