...
- `sessionctl`: a headless two-client composition covering protected capability
  ...
  binary/artifact binding and bounded multi-surface secret/canary scans. ADR 0027
